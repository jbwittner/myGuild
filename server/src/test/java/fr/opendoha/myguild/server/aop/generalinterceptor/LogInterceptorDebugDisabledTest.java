...
/**
 * Test class to test logInterceptorDebugEnabled method with log disabled
 */
@ActiveProfiles("aoptestdisabled")
public class LogInterceptorDebugDisabledTest extends AbstractMotherIntegrationTest {
