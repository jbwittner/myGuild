 ...
 * Test of updateGuild
 */
public class UpdateGuildTest extends AbstractMotherIntegrationTest {
    ...
    private void generateData() throws IOException {
        ...
        Mockito.when(this.blizzardAPIHelper.getGuildRosterIndexData(this.realmSlug, this.guildName))
     ...
     */
    @Test
    public void testUpdateGuild() throws UnexpectedException, IOException {
        this.generateData();

        this.mockGuildServiceImpl.updateGuild();

        this.checkData();
    }

    /**
     * Test of twice call of updateGuild
     */
    @Test
    public void testTwice() throws UnexpectedException, IOException {
        this.generateData();
